...
<div class="container">
	<div class="login-form">    
	    <form action="/MovieBingeOffline/processSignup" method="post">
			<div class="avatar"><i class="material-icons">account_circle</i></div>
	    	<h4 class="modal-title">Sign up a User Account</h4>
	  	...
	  	<div class="text-center small">Already have an account? <a href="/MovieBingeOffline/user/signin">Sign In</a></div>
	</div>	
</div>
