   ...
   <c:forEach items="${allMovies}" var="movie" varStatus="i">
     <tr>
      ...
      <!-- <td class="text-center">
       ...
       <td>
       		<a rel="tooltip" class="btn btn-danger btn-just-icon" data-toggle="modal" data-target="#confirm-submit">
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <a href="/MovieBingeOffline/deleteMovies/${movie.movieId}" id="submit" class="btn btn-success success">Yes</a>
            </div>
        </div>
    </div>
</div>
 ...
 <ul class="pagination pagination-info">
      ...
      <c:forEach varStatus="pageId" begin="0" end="${total_pages-1}">
	      <li class="active page-item">
	        <a href="/MovieBingeOffline/deletePagination/${pageId.index+1}" class="page-link">${pageId.index+1}</a>
	      </li>
      </c:forEach>
      <li class="page-item">
